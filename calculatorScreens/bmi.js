...
class BMI extends React.Component {
  ...
  calculate = () => {
    if (this.state.weight !== 0 && this.state.height !== 0) {
      ...
      this.setState({
        bmi,
        progress: ((bmi * 2) / 100) * 0.7,
      });
      ToastAndroid.show('BMI Calculated', ToastAndroid.SHORT);
      if (bmi > 30) {
        this.setState({
          result: 'Obese',
          color: 'red',
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.subHeading}>
          <Text style={styles.subHeadingText}>BMI Calculator</Text>
        </View>
        <View style={styles.bmiCalc}>
          ...
          <View style={styles.bmiResultContainer}>
            <Text style={styles.bmiText}>BMI : {this.state.bmi}</Text>
        ...
        <Image
          ...
          source={{
            uri:
              'https://www.bajajfinservmarkets.in/content/dam/bajajfinserv/calculators/bmi/bmi-result-p.png',
          }}
        />
        </View>
      </View>
